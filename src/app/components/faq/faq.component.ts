...
export class FaqComponent implements OnInit {
  ...
  FAQs: Array<FAQ> = [
    { header: "Dostawa i Platność", text: "todo: text", router: { link:'/platnosc', text: 'Dostawa i Platność'}},
    { header: "Jak długo żyją motyli?", text: "Motyli tropikalne jedzą słodkie soczystę warzywa, np. pomaranczy, lub słodką wodę. Wystarczy hodować raz dziennie.", router: null},
